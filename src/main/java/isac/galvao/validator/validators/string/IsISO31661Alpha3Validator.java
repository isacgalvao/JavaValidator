...
import isac.galvao.validator.annotations.string.IsISO31661Alpha3;
...
/**
 * Check if the string is a valid [ISO 3166-1 alpha-3](<a href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3">wiki</a>) officially assigned country code.
 */
public class IsISO31661Alpha3Validator implements AnnotationValidatorInterface<IsISO31661Alpha3> {

    final Set<String> validISO31661Alpha3CountriesCodes = Set.of(
    ...
    @Override
    public boolean validate(FieldHelper helper, IsISO31661Alpha3 annotation) {
        Object valor = helper.getValue();

        if (Objects.isNull(valor)) return false;

        if (valor instanceof String) {
            return this.validISO31661Alpha3CountriesCodes.contains(((String) valor).toUpperCase());
        }
    ...
    @Override
    public ValidationError buildMessage(FieldHelper helper, IsISO31661Alpha3 annotation) {
        String message = String.format("'%s' precisa ser um código ISO31661 Alpha3 válido", helper.getAttributeName());
